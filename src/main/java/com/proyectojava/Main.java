...
public class Main {
    public static void main(String[] args) throws ParseException {
         ...
         * 
         * CountryMySQLRepository countryRepository = new
         * CountryMySQLRepository(url,user,password);
         * CitiesMySQLRepository citiesRepository = new
         * CitiesMySQLRepository(url,user,password);
         * AirportMySQLRepository airportMySQLRepository = new
         * AirportMySQLRepository(url,user,password);
         * ModelMySQLRepository modelMySQLRepository = new
         * ModelMySQLRepository(url,user,password);
         * ManufacturerMySQLRepository manufacturerMySQLRepository = new
         * ManufacturerMySQLRepository(url,user,password);
         * GateMySQLRepository gateMySQLRepository = new GateMySQLRepository(url,
         * user,password);
         * 
         * DocumenttypeMySQLRepository documenttypeMySQLRepository = new
         * DocumenttypeMySQLRepository(url,user,password);
         * TripbookingMySQLRepository tripbookingMySQLRepository = new
         * TripbookingMySQLRepository(url,user,password);
         * FlightfareMySQLRepository flightfareMySQLRepository = new
         * FlightfareMySQLRepository(url,user,password);
         * TripBookingDetailsMySQLRepository tripBookingDetailsMySQLRepository = new
         * TripBookingDetailsMySQLRepository(url,user,password);
         * TripMySQLRepository tripbookingMySQLrepository = new
         * TripMySQLRepository(url,user,password);
         * AirlineMySQLRepository airlineMySQLRepository = new
         * AirlineMySQLRepository(url, user, password);
         * PlaneMySQLRepository planeMySQLRepository = new PlaneMySQLRepository(url,
         * user, password);
         * 
         * 
         ...
         * manufacturerMySQLRepository);
         * ManufacturerService manufacturerService = new
         * ManufacturerService(manufacturerMySQLRepository);
         * GateService gateService = new GateService(gateMySQLRepository,
         * airportMySQLRepository);
         * 
         * DocumenttypeService documenttypeService = new
         * DocumenttypeService(documenttypeMySQLRepository);
         * TripbookingService tripbookingService2 = new
         * TripbookingService(tripbookingMySQLRepository,tripbookingMySQLrepository);
         * FlightfareService flightfareService = new
         * FlightfareService(flightfareMySQLRepository);
         * TripBookingDetailsService tripBookingDetailsService = new
         * TripBookingDetailsService(tripBookingDetailsMySQLRepository,
         * tripbookingMySQLRepository,
         * customerMySQLRepository,flightfareMySQLRepository);
         ...
         * // PlaneService planeService = new PlaneService(planeMySQLRepository, null,
         * modelMySQLRepository);
         * 
         * 
         * 
         * // Inicialización de los adaptadores de consola
         * CitiesConsoleAdapter citiesConsoleAdapter = new
         * CitiesConsoleAdapter(citiesService);
         * CountryConsoleAdapter countryConsoleAdapter = new
         * CountryConsoleAdapter(countryService);
         * AirportConsoleAdapter airportConsoleAdapter = new
         * AirportConsoleAdapter(airportService);
         * ModelConsoleAdapter modelConsoleAdapter = new
         * ModelConsoleAdapter(modelService);
         * ManufacturerConsoleAdapter manufacturerConsoleAdapter = new
         * ManufacturerConsoleAdapter(manufacturerService);
         * GateConsoleAdapter gateConsoleAdapter = new GateConsoleAdapter(gateService);
         * CustomerConsoleAdapter customerConsoleAdapter = new
         * CustomerConsoleAdapter(customerService);
         * DocumenttypeConsoleAdapter documenttypeConsoleAdapter = new
         * DocumenttypeConsoleAdapter(documenttypeService);
         * TripbookingConsoleAdapter tripbookingConsoleAdapter = new
         * TripbookingConsoleAdapter(tripbookingService2);
         * FlightfareConsoleAdapter flightfareConsoleAdapter = new
         * FlightfareConsoleAdapter(flightfareService);
         * TripBookingDetailsConsoleAdapter tripBookingDetailsConsoleAdapter = new
         * TripBookingDetailsConsoleAdapter(tripBookingDetailsService);
         * TripConsoleAdapter tripConsoleAdapter = new TripConsoleAdapter(tripService);
         * AirlineConsoleAdapter airlineConsoleAdapter = new
         * AirlineConsoleAdapter(airlineService);
         * // PlaneConsoleAdapter planeConsoleAdapter = new
         * PlaneConsoleAdapter(planeService);
         * 
